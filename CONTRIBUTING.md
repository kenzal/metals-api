...
> - Sponsor the creator on [GitHub Sponsors](https://github.com/sponsors/kenzal)
> - Lift the package on [Tidelift](https://tidelift.com/lifter/search/packagist/kenzal%2Fmetals-api)
...
[Metals-API Code of Conduct](https://github.com/kenzal/metals-apiblob/master/CODE_OF_CONDUCT.md).
...
> available [Documentation](https://github.com/kenzal/metals-api/blob/main/README.md).

Before you ask a question, it is best to search for existing [Issues](https://github.com/kenzal/metals-api/issues) that
...
- Open an [Issue](https://github.com/kenzal/metals-api/issues/new).
...
- Determine if your bug is really a bug and not an error on your side e.g. using incompatible environment
  ...
  the [documentation](https://github.com/kenzal/metals-api/blob/main/README.md). If you are looking for support, you
  might want to check [this section](#i-have-a-question)).
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there
  is not already a bug report existing for your bug or error in
  the [bug tracker](https://github.com/kenzal/metals-apiissues?q=label%3Abug).
...
> to [the maintainer](mailto:kenzal.hunter+metals-api@gmail.com).
<!-- You may add a PGP key to allow the messages to be sent encrypted as well. -->

We use GitHub issues to track bugs and errors. If you run into an issue with the project:

- Open an [Issue](https://github.com/kenzal/metals-api/issues/new). (Since we can't be sure at this point whether it is
...
This section guides you through submitting an enhancement suggestion for Metals-API, **including completely new features
...
- Make sure that you are using the latest version.
- Read the [documentation](https://github.com/kenzal/metals-api/blob/main/README.md) carefully and find out if the
  functionality is already covered, maybe by an individual configuration.
- Perform a [search](https://github.com/kenzal/metals-api/issues) to see if the enhancement has already been suggested.
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/kenzal/metals-api/issues).
...
- **Explain why this enhancement would be useful** to most Metals-API users. You may also want to point out the other
...
Nothing special here, just clone the project locally and create a branch for your contribution.

### Improving The Documentation

Aside from in-code documentation (php doc-blocks), this project is severely lacking in documentation. Any contributions
